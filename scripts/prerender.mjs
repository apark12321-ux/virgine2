...
function buildPostBody(post, allPosts = []) {
  ...
  return `
    <article>
      ...
      <main>${post.content
        .replace(/<!--CALC:didimdol-->/g, '<p class="calc-cta"><a href="/tools/didimdol">🧮 디딤돌 우대금리 계산기로 직접 계산해보기 →</a></p>')
        .replace(/<!--CALC:cheongyak-->/g, '<p class="calc-cta"><a href="/tools/cheongyak">🧮 신혼특공 가점 계산기로 직접 계산해보기 →</a></p>')}</main>
      ${relatedHtml}
      <footer>
