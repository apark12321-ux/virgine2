...
const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "일반 가점 청약에서는 주택공급에 관한 규칙 제53조에 의거해 만 60세 이상의 직계존속(부모, 조부모)이 소유한 주택은 신청자 본인을 무주택으로 간주해 줍니다. 그러나 매우 중요하게도 '특별공급(신혼특공, 다자녀특공, 노부모부양 등)' 청약 시에는 이 60세 이상 무주택 인정 조항이 철저하게 배제됩니다! 즉, 직계존속이 주택을 소유하고 있다면 신혼부부 특별공급 청약 시에는 무주택 가구 자격을 박탈당하거나 부적격 탈락하므로, 부모님과 주민등록상 세대가 합쳐져 있다면 공고일 전에 미리 세대 분리를 완수해야 안전합니다."
  }
];
        ...
        <div className="max-w-4xl">
          ...
          <div className="space-y-6 text-[14.5px] text-[#3F3D56] leading-[1.8] break-keep">
            ...
            <div className="bg-[#F5F6FD] rounded-[12px] p-5 border border-[#E2E4F0] my-6">
              <h4 className="font-bold text-[#151320] text-[15px] mb-3">[체크포인트] 공공분양 신혼특공 핵심 당첨 팁</h4>
