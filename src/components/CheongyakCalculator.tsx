      ...
      <section className="mt-10 bg-[#F5F6FD] border border-[#E2E4F0] rounded-[12px] p-5 sm:p-6">
        ...
        <div className="space-y-2.5 text-[13px] text-[#5B5870] leading-[1.7]">
          ...
          <p className="pt-2">
            ...
            <a href="https://www.applyhome.co.kr" className="text-[#D45A45] underline underline-offset-2">청약홈(applyhome.co.kr) 공식 가점 계산기</a>
            {" · "}
            <a href="https://www.law.go.kr" className="text-[#D45A45] underline underline-offset-2">주택공급에 관한 규칙(법제처)</a>
            {" · "}
            <a href="https://www.molit.go.kr" className="text-[#D45A45] underline underline-offset-2">국토교통부 신혼부부 특별공급 운영지침</a>
          </p>
